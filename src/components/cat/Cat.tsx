        ...
        >
          ...
          {currentHat && !showPettingImg && !isDragging && (() => {
            ...
            const hatOverride: Record<string, { dy: number; dx: number }> = {
              "tophat/brown/stand": { dy: 8, dx: 4 },
              "tophat/brown/walk":  { dy: 8, dx: -2 },
              "tophat/white/stand":  { dy: 2, dx: 0 },
              "tophat/white/walk":   { dy: 2, dx: 0 },
              "tophat/white/sit":    { dy: 2, dx: 0 },
              "tophat/white/sleep":  { dy: 4, dx: -2 },
              "tophat/orange/stand": { dy: 2, dx: 2 },
              "tophat/orange/walk":  { dy: 0, dx: 0 },
              "tophat/orange/sit":   { dy: 2, dx: -4 },
              ...
              "tophat/brown/sit":   { dy: 0, dx: 2 },
              "tophat/brown/sleep": { dy: 2, dx: 2 },
              "crown/white/stand":  { dy: -2, dx: 0 },
              "crown/white/walk":   { dy: -4, dx: 0 },
              "crown/white/sit":    { dy: -2, dx: 0 },
              "crown/white/sleep":  { dy: -2, dx: -2 },
              "crown/orange/stand": { dy: 2, dx: 0 },
              "crown/orange/walk":  { dy: -2, dx: 0 },
              "crown/orange/sit":   { dy: -6, dx: -4 },
              "crown/orange/sleep": { dy: 0, dx: -4 },
              "crown/brown/stand":  { dy: 0, dx: 8 },
              "crown/brown/walk":   { dy: 0, dx: 4 },
              "crown/brown/sit":    { dy: 2, dx: 2 },
              "crown/brown/sleep":  { dy: 2, dx: 0 },
              "wizard/white/stand":  { dy: -2, dx: -2 },
              "wizard/white/walk":   { dy: -2, dx: 0 },
              "wizard/white/sit":    { dy: -4, dx: 0 },
              "wizard/white/sleep":  { dy: 0, dx: -2 },
              "wizard/orange/stand": { dy: -2, dx: -2 },
              "wizard/orange/walk":  { dy: -4, dx: 0 },
              "wizard/orange/sit":   { dy: -2, dx: -2 },
              "wizard/orange/sleep": { dy: 2, dx: -4 },
              "wizard/brown/stand":  { dy: 0, dx: 4 },
              "wizard/brown/walk":   { dy: 2, dx: 2 },
              "wizard/brown/sit":    { dy: 2, dx: 0 },
              "wizard/brown/sleep":  { dy: 2, dx: 0 },
              "party_hat/brown/stand":  { dy: 2, dx: 4 },
              "party_hat/brown/walk":   { dy: 2, dx: 4 },
              "party_hat/brown/sit":    { dy: 2, dx: 2 },
              "party_hat/brown/sleep":  { dy: 2, dx: 0 },
              "party_hat/orange/stand": { dy: -2, dx: -2 },
              "party_hat/orange/walk":  { dy: -2, dx: 0 },
              "party_hat/orange/sit":   { dy: -2, dx: -2 },
              "party_hat/orange/sleep": { dy: 0, dx: -2 },
              "party_hat/white/stand":  { dy: 0, dx: 0 },
              "party_hat/white/walk":   { dy: -2, dx: 0 },
              "party_hat/white/sit":    { dy: 0, dx: 0 },
              "party_hat/white/sleep":  { dy: 0, dx: 0 },
              "tuna/white/stand":   { dy: 6, dx: 0 },
              "tuna/white/walk":    { dy: 4, dx: 0 },
              "tuna/white/sit":     { dy: 4, dx: 2 },
              "tuna/white/sleep":   { dy: 6, dx: -2 },
              "tuna/orange/stand":  { dy: 6, dx: -4 },
              "tuna/orange/walk":   { dy: 4, dx: 0 },
              "tuna/orange/sit":    { dy: 4, dx: -2 },
              "tuna/orange/sleep":  { dy: 2, dx: 0 },
              "tuna/brown/stand":   { dy: 8, dx: -10 },
              "tuna/brown/walk":    { dy: 8, dx: 6 },
              "tuna/brown/sit":     { dy: 0, dx: -4 },
              "tuna/brown/sleep":   { dy: 10, dx: -2 },
            };
